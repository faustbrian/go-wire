...
- Parsing correctness, interoperability, resource limits, and malformed-input
  handling MUST be treated as security boundaries for every wire format.
- Format-specific behavior MUST remain explicit; convenience APIs MUST NOT
  conceal lossy conversions or unsupported semantics.
