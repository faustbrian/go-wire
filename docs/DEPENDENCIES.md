...
| BSON | `go.mongodb.org/mongo-driver/v2 v2.8.0` | Official MongoDB BSON implementation and canonical ObjectID, datetime, raw document, and registry types | Actively maintained official stable driver. Only the BSON package is imported; network/client behavior is not part of `go-wire`. |
